...
\begin{figure}[!h]
  ...
  \caption{\csentence{Coiled-Coil Interaction -- best fitting PyDock configuration.} \OpBook showing the contact zone of the best fitting PyDock model (orange) and 4UX3 crystal (blue). On top the overlapping contact zones on reference protein are shown. The bottom part of the image depicts the paired proteins.}
