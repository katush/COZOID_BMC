...
Here it is important to understand that the reference protein shown in the Figure~\ref{fig:case12} (the biggest one) actually represents three overlapping aligned reference proteins, each coming from one configuration.
...
Figure~\ref{fig:case12} depicts a set of three configurations before (a) and after (b) applying the \ExpView.
...
For each matching pair of interacting amino acids in the contact zones of the reference and paired proteins of the selected configurations the similarity score is increased by four.
...
In our particular case, the leucine 97 and methionine 23 amino acids were in the contact distance in only three configurations out of the initial 40. 
...
\begin{figure}[h!]
  ...
  \caption{\csentence{The \MatView of interacting amino acids in all HADDOCK models.} The \MatView indicates that the selected pair of M186 and I1030 amino acids is present in 10 out of 40 loaded models.}
...
\begin{figure}[h!]
  ...
  \includegraphics[width=\columnwidth]{images/figure13.pdf}
    \caption{\csentence{Best fit PyDock configuration.} \CoZoList comparing the 4UX3 crystal with one best fit PyDock model with respect to the distances of amino acids.}
  \label{fig:coiled2}
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption{\csentence{Best fit PyDock configuration.} \OpBook showing the contact zone of the best fitting PyDock model (orange) and 4UX3 crystal (blue).}
...
\begin{figure}[h!]
    ...
    \caption{\csentence{Sorting of amino acids according to distance.} \CoZoList sorted according to the distance of amino acids shows that the V200-R300 pair is one of the closest ones in the crystal as well as in all selected models.}
...
\begin{figure}[h!]
    ...
    \caption{\csentence{Best fit PyDock.}(a) Best 5 PyDock models with the distance parameter 4 \AA. The crystal is blue. The model, which exhibited the most similar contacts with the crystal, is orange and the remaining models are green. (b) \ExpView showing the comparison of contact zones of best the PyDock model (orange) with crystal (blue).}
