...
\setlength{\textfloatsep}{10pt plus 5.0pt minus 10.0pt}
\setlength{\floatsep}{15pt plus 20.0pt minus 0.0pt}
...
The system follows the workflow of proteomics experts. 
The first visual abstraction method is based on customized interactive heat maps and provides an overview of all possible residue-residue contacts in PPI configurations. 
Models containing a particular pair of interacting amino acids can be selectively picked and traversed. 
The detailed information about individual contact zones and their properties is presented by the contact-zone list-view. 
These techniques are interactively linked with 3D representations that employ exploded views and open-book views to solve the problem of high overlaps of the configurations. 
...
\begin{figure}[tb]
  \centering	
  \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/pdbsum1.pdf}}
  \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/pdbsum2.pdf}}
...
\begin{figure}[tb]
    \centering
    \subfigure[]{\includegraphics[width=0.4\columnwidth]{images/exp2.pdf}}
    \subfigure[]{\includegraphics[width=0.5\columnwidth]{images/exp2.png}}
    \vspace{-4pt}
...
\begin{figure}[tb]
    \centering
    \vspace{-5pt}
      \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/list2a.pdf}}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/list2b.pdf}}
    \vspace{-5pt}
...
\begin{figure}[tb]
    \centering
    \vspace{-5pt}
 	\subfigure[]{\includegraphics[width=0.3\columnwidth]{images/sorting2a.pdf}}
    \subfigure[]{\includegraphics[width=0.3\columnwidth]{images/sorting2b.pdf}}
    \subfigure[]{\includegraphics[width=0.3\columnwidth]{images/sorting2c.pdf}}
    \vspace{-5pt}
...
\begin{figure*}[tb]
    \centering
    \vspace{-5pt}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/case3_shorteneda.pdf}}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/case3_shortenedb.pdf}}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/case3_shortenedc.pdf}}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/case3_shortenedd.pdf}}
    \vspace{-5pt}
...
\begin{figure}[ht!]
    \centering
    \vspace{10pt}
      \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/best_paira.pdf}}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/best_pairb.pdf}}
    \vspace{5pt}
...
\begin{figure}[b!]
	\vspace{-10pt}
    \centering
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/3EUHa.pdf}}
    \subfigure[]{\includegraphics[width=0.47\columnwidth]{images/3EUHb.pdf}}
    \vspace{-5pt}
...
\begin{figure*}[t!]
    \centering
    \vspace{-5pt}
     \subfigure[]{\includegraphics[width=0.47\columnwidth]{images/list_pocket_stringa.pdf}}
    \subfigure[]{\includegraphics[width=0.47\columnwidth]{images/list_pocket_stringb.pdf}}
     \subfigure[]{\includegraphics[width=0.47\columnwidth]{images/list_pocket_stringc.pdf}}
    \subfigure[]{\includegraphics[width=0.47\columnwidth]{images/list_pocket_stringd.pdf}}
    \vspace{-5pt}
...
\begin{figure}[htb]
    \centering 
    \vspace{-1pt}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/pydocka.png}}
    \subfigure[]{\includegraphics[width=0.45\columnwidth]{images/pydockb.png}}
    \vspace{-5pt}
