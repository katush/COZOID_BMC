...
\setlength{\textfloatsep}{10pt plus 0.0pt minus 10.0pt}
\setlength{\floatsep}{15pt plus 5.0pt minus 0.0pt}
...
\sloppy{Our newly proposed system enables for the efficient visual exploration of a large number of PPI complexes.
...
\begin{figure*}[tb]
    \centering
    \includegraphics[width=1.6\columnwidth]{figure5.pdf}
...
\begin{figure}[tb]
    \centering
  \includegraphics[width=0.95\columnwidth]{figure8.pdf}
      \vspace{-5pt}
...
\begin{figure*}[tb]
    \centering
    \includegraphics[width=1.87\columnwidth]{figure9.pdf}
    \vspace{-5pt}
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.95\columnwidth]{figure10.pdf}
...
\begin{figure}[b]
  \centering
  \vspace{5pt}
  \includegraphics[width=0.95\columnwidth]{figure11.png}
...
\begin{figure}[!hb]
  \centering
  \includegraphics[width=0.84\columnwidth]{figure14.png}
  \vspace{-5pt}
...
\begin{figure*}[tb]
    \centering
    \includegraphics[width=1.9\columnwidth]{figure16.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.65\columnwidth]{figure17.png}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.95\columnwidth]{figure18.pdf}
...
\begin{figure}[htb]
    \centering 
    \includegraphics[width=0.95\columnwidth]{figure19.pdf}
